package library.widget.chart.model;
...
import library.widget.chart.formatter.LineChartValueFormatter;
import library.widget.chart.formatter.SimpleLineChartValueFormatter;
...
public class Line {
    ...
    public Line(Line line) {
        ...
        this.isContinuous = line.isContinuous;
    ...
    /**
     * 当Y值为0的情况下是否继续绘制
     * @param continuous false:绘制出来中断的线条
     */
